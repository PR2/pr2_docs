...
either wired or wireless connections.  Additionally, the robot can be
accessed via the basestation through a VPN tunnel.
...
\item \texttt{10.68.0.0}: Robot Internal Network 1. The
  ...
  addresses on this subnet.  Additinoally, many of the ethernet-based
  ...
  Access Point are directly connected to this network.  The master
  computer, if booted, will give out IP addresses via DHCP in the
  range \texttt{10.68.0.100-10.68.0.199}.  Important addresses on this
  network:
  \begin{itemize}
...
direct access to the Robot Internal Network.
...
For the remainder of this section in our examples we will assume that
our basestation has been given the hostname \texttt{prbase1}, and our
computers will be named \texttt{prx1} and \texttt{prx2}, and are
...
paired to.  Review the section BLAH for an explanation of the network
overview.
