...
Rather than diving into all 32 DOF's of the PR2 in detail, we'll examine the robot by its major components:  head, torso, arms, base and casters as depicted in Figure~\ref{fig:pr2_basic_breakdown}.
...
\subsubsection{Arms}
The PR2 arms can be further subdivided into shoulder, upper arm, forearm and gripper.
