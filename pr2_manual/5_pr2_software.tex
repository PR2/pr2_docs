...
\label{fig:dashboard}
\end{figure}
The robot will not usually start up with all green lights. In fact, if you bring up the robot properly, then you should see a dashboard display that looks more like Figure~\ref{fig:dashboard1.png}.
\begin{figure}[h]
\centering
...
\end{figure}
The dashboard should look like Figure~\ref{fig:dashboard1.png} because the wireless run-stop should be off. You can tell that the wireless run-stop is off by mousing over the dashboard to see the tooltips, which describe what each icon means. See Figure~\ref{fig:dashboard2.png}.
...
Now you can enable the wireless run-stop by pressing the green "START" button on the wireless run-stop. If this works properly, then you should see the robot run-stop icon turn green in the dashboard. The dashboard should update to look like Figure~\ref{fig:dashboard3.png}.
