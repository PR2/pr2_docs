...
\begin{figure}[h]
\centering
\includegraphics{opening_runstop.png}
...
On a computer with a built ROS installation (e.g., the base-station desktop computer that ships with the robot), set your ROS\_MASTER\_URI 
