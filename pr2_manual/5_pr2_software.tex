...
open area with at least 15 feet of space infront of the the panel labeled {\bf
  OPEN THIS PANEL FIRST}, Figure~\ref{fig:crate_space}.

\begin{figure}[h]
\centering
\includegraphics[width=200px]{crate_area.png}
...
use later. Inside the crate is a vaccuum sealed PR2,
Figure~\ref{fig:sealPR2}, start by unlatching the two boards holding
the head in place.

\begin{figure}[h]
\centering
\includegraphics[width=200px]{vaccuumpacked.png}
