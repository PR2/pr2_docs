...
\end{figure}
\label{toolkit}
A toolkit is provided with the PR2.  To avoid damaging the robot or injuring yourself, you should always these tools to follow the Repair and Replacement procedures at support.willowgarage.com when performing any hardware maintenance on the robot.
...
\includegraphics[scale=0.6]{urdf_sensors.png}
...
\item[Wide Stereo Camera] The wide stereo camera is part of the dual stereo pair
  ...
  \href{http://www.ros.org/wiki/wge100_camera}{wge100_camera} package at
  \href{http://www.ros.org}{ros.org}.
...
\href{http://www.ros.org/wiki/pr2_camera_synchronizer}{pr2_camera_synchronizer} package at
\href{http://www.ros.org}{ros.org}.
